...
export default async function LoginPage(props: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-[#FDFCF0] font-sans">
      ...
      <div className="w-full max-w-md bg-white p-10 md:p-14 rounded-[3.5rem] shadow-2xl border-b-8 border-orange-100 animate-in fade-in zoom-in duration-700">
        <h1 className="text-4xl font-black text-center mb-10 text-gray-900 tracking-tighter uppercase italic">Akwaba !</h1>
        
        {error && (
          <div className="mb-8 p-4 bg-red-50 text-red-600 rounded-[2rem] text-xs font-bold border border-red-100 flex items-center gap-3">
